...
auditpol /set /subcategory:"Filtering Platform Connection" /success:disable /failure:enable >nul 2>nul
FOR /F "tokens=1,2*" %%V IN ('bcdedit') DO SET adminTest=%%V >nul 2>nul
